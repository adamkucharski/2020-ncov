---
title: "Analysis of transmission and control of nCoV in Wuhan"
output:
...
• **To estimate the early dynamics of transmission in Wuhan, we fitted a mathematical model to multiple available datasets** on international exported cases from Wuhan and cases in Wuhan. Fitting to multiple data sources rather than a single dataset (or data point) is particularly useful for estimates real-time, because some datasets may be unreliable. 
